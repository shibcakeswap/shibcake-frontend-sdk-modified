...
const FarmAuctionsBanner = () => {
  ...
  return (
    <Wrapper>
      <Inner>
        <LeftWrapper>
          <StyledSubheading>{t('Stake SHIBCAKE...')}</StyledSubheading>
          <StyledHeading scale="xl">{t('Earn CAKE')}</StyledHeading>
          <Link href="https://pancakeswap.finance/swap#/swap?outputCurrency=0x90bdF238674569684a34F3AF8a3F55f08088bc98">
            <Button>
              <Text color="invertedContrast" bold fontSize="16px" mr="4px">
                {t('Buy on PancakeSwap (Slippage 21-26%)')}
              </Text>
